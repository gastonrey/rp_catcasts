          ...
          fn f ->
            {
              ...
              elem(
                hidden_input(f, :sort,
                  value: sort,
                  class:
                    "appearance-none block w-full bg-white text-grey-darkest border border-grey-lighter rounded py-1 px-2 leading-tight focus:outline-none focus:bg-white focus:border-grey"
                ),
                1
              ) ++
                elem(
