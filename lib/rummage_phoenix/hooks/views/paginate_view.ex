  ...
  defmacro __using__(opts) do
    quote do
      ...
      defp raw_disabled_link(name) do
        """
        <li class="inline">
          <a class="relative py-2 px-4 no-underline leading-normal text-grey-dark bg-white border border-grey -ml-px cursor-not-allowed" href="#" tabindex="-1">#{
          name
        }</a>
        </li>
        """
      ...
      defp raw_link(name, url) do
        """
        <li class="inline">
          <a class="relative py-2 px-4 no-underline leading-normal text-grey-darkest bg-white border border-grey -ml-px hover:z-20 hover:bg-grey-light hover:bg-grey" href="#{
          url
        }">#{name}</a>
        </li>
        """
      ...
      defp raw_active_link(name) do
        """
        <li class="inline">
          <a class="relative py-2 px-4 leading-normal no-underline text-grey-lighter bg-grey-darkest border border-grey-darkest -ml-px z-30" href="#">#{
          name
